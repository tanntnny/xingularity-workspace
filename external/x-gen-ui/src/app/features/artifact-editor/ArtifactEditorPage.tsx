        ...
        {validationErrors.length ? (
          <div className="mt-3 rounded-xl border border-rose-200 bg-rose-50 p-4 text-rose-900">
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <Button onClick={copyCorrectionPrompt}>
        ...
        <div className="mb-3 flex items-center justify-between gap-2">
          <div>
            ...
            <p className="text-slate-600">
              Valid artifacts render through safe registry components.
            </p>
          </div>
          <Button disabled={!currentArtifact} onClick={() => setPage('preview')} variant="primary">
            Render Artifact
          </Button>
        </div>
