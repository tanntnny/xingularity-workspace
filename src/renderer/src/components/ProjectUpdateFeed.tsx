  ...
  return (
    ...
    >
      {sortedUpdates.map((update) => (
        ...
        >
          <article className="p-4" data-testid={`project-update-feed-item:${update.id}`}>
            <div className="flex flex-wrap items-center gap-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuItem onSelect={() => setPendingDeleteId(update.id)}>
            ...
            <div className="note-editor-surface mt-3 rounded-md px-3 py-2">
              <Editor
