export const IPC_CHANNELS = {
  ...
  generativeUiListArtifacts: 'generative-ui:list-artifacts',
  generativeUiSaveArtifact: 'generative-ui:save-artifact',
  generativeUiDeleteArtifact: 'generative-ui:delete-artifact',
