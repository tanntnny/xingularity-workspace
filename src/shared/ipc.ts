export const IPC_CHANNELS = {
  ...
  vaultSyncSnapshot: 'vault:sync-snapshot',
  vaultReconcile: 'vault:reconcile',
  vaultCreateBackup: 'vault:create-backup',
  vaultConflictDetails: 'vault:conflict-details',
  vaultResolveConflict: 'vault:resolve-conflict',
  vaultDiscardConflictRecovery: 'vault:discard-conflict-recovery',
  ...
  desktopOpenTerminal: 'desktop:open-terminal',
  ...
  readNoteDocumentWithRevision: 'files:read-note-document-with-revision',
  ...
  writeNoteDocumentWithRevision: 'files:write-note-document-with-revision',
  ...
  resourcesSetProjectLinks: 'resources:set-project-links',
  ...
  appPrepareToClose: 'app:prepare-to-close',
  appPrepareToCloseResponse: 'app:prepare-to-close-response',
  ...
  createProjectMeeting: 'projects:meetings:create',
  updateProjectMeeting: 'projects:meetings:update',
  deleteProjectMeeting: 'projects:meetings:delete',
  createTask: 'tasks:create',
  duplicateTask: 'tasks:duplicate',
  configureTaskRecurrence: 'tasks:configure-recurrence',
